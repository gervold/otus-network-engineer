...
**IPv6** адреса будем генерировать, на основе IPv4 адресов и номера офиса,
по следующему правилу (описано на python):

```python
def convert_4_to_6(ipv4, office_num):
    a,b,c,d = ipv4.split('.')
    print("2001::"+str(office_num)+":"+":".join([a,b,c,d])+"<br>FE80::" + d)
    
# Пример:
convert_4_to_6('52.1.0.21', 2)
'2001::2:52:1:0:21'
```
...
2001:<ASN>:<Device>:<Eth0>:10:0:2:25
...
|---|---|---|---|---|---|---|
| VPC1 | eth0 | 100.0.0.1 | 2001::100:0:0:1 | - | VPC1 eth0–e0/2 SW3 | |
| VPC7 | eth0 | 100.0.1.7 | 2001::100:0:1:7 | - | VPC7 eth0–e0/2 SW2 | |
...
|---|---|---|---|---|---|---|
| R21 | e0/0 | **30.0.0.21** | 2001:30:0:0::21<br>FE80::21 | - | R21 e0/0 – e0/2 R15 | BGP, Customer link |
|  | e0/1 | 192.168.0.21 | 2001:192:168:0::21<br>FE80::21 | - | R21 e0/1 – e0/1 R22 | BGP, Peering link |
|  | e0/2 | **52.0.0.21** | 2001:52:0:0::21<br>FE80::21 | - | R21 e0/2 – e0/0 R24 | BGP, Provider link |
...
| Device Name | Port | IPv4 | IPv6 | VLAN | Link | Comment |
|---|---|---|---|---|---|---|
| R22 | e0/0 | **101.0.0.22** | 2001:101:0:0::22<br>FE80::22 | - | R22 e0/0 – e0/2 R14 | BGP, Customer link |
|  | e0/1 | 192.168.0.22 | 2001:192:168:0::22<br>FE80::22 | - | R22 e0/1 – e0/1 R21 | BGP, Peering link |
|  | e0/2 | **52.0.0.22** | 2001:52:0:0::22<br>FE80::22 | - | R22 e0/2 – e0/0 R23 | BGP, Provider link |
...
| Device Name | Port | IPv4 | IPv6 | VLAN | Link | Comment |
|---|---|---|---|---|---|---|
| R23 | e0/0 | **52.0.0.23** | 2001:52:0:0::23<br>FE80::23 | - | R23 e0/0 – e0/2 R22 | BGP, Customer link |
|  | e0/1 | 10.0.1.23 | 2001:10:0:1::23<br>FE80::23 | - | R23 e0/1 – e0/0 R25 | Connectivity |
|  | e0/2 | 10.0.0.23 | 2001:10:0:0::23<br>FE80::23 | - | R23 e0/2 – e0/2 R24 | Connectivity |
| R24 | e0/0 | **52.0.0.24** | 2001:52:0:0::24<br>FE80::24 | - | R24 e0/0 – e0/2 R21 | BGP, Customer link |
|  | e0/1 | 10.0.3.24 | 2001:10:0:3::24<br>FE80::24 | - | R24 e0/1 – e0/0 R26 | Connectivity |
|  | e0/2 | 10.0.0.24 | 2001:10:0:0::24<br>FE80::24 | - | R24 e0/2 – e0/2 R23 | Connectivity |
|  | e0/3 | **52.0.1.24** | 2001:52:0:1::24<br>FE80::24 | - | R24 e0/3 – e0/2 R18 | BGP, Customer link |
| R25 | e0/0 | 10.0.1.25 | 2001:10:0:1::25<br>FE80::25 | - | R25 e0/0 – e0/1 R23 | Connectivity |
|  | e0/1 | **52.0.5.25** | 2001:52:0:5::25<br>FE80::25 | - | R25 e0/1 – e0/0 R27 | BGP, Customer link |
|  | e0/2 | 10.0.2.25 | 2001:10:0:2::25<br>FE80::25 | - | R25 e0/2 – e0/2 R26 | Connectivity |
|  | e0/3 | **52.0.4.25** | 2001:52:0:4::25<br>FE80::25 | - | R25 e0/3 – e0/1 R28 | BGP, Customer link |
| R26 | e0/0 | 10.0.3.26 | 2001:10:0:3::26<br>FE80::26 | - | R26 e0/0 – e0/1 R24 | Connectivity |
|  | e0/1 | **52.0.3.26** | 2001:52:0:3::26<br>FE80::26 | - | R26 e0/1 – e0/0 R28 | BGP, Customer link |
|  | e0/2 | 10.0.2.26 | 2001:10:0:2::26<br>FE80::26 | - | R26 e0/2 – e0/2 R25 | Connectivity |
|  | e0/3 | **52.0.2.26** | 2001:52:0:2::26<br>FE80::26 | - | R26 e0/3 – e0/3 R18 | BGP, Customer link |


### Лабынтаги
| Device Name | Port | IPv4 | IPv6 | VLAN | Link | Comment |
|---|---|---|---|---|---|---|
| R27 | e0/0 | **52.0.5.27** | 2001:52:0:5::27<br>FE80::27 | - | R27 e0/0 – e0/1 R25 | Default |
...
| Device Name | Port | IPv4 | IPv6 | VLAN | Link | Comment |
|---|---|---|---|---|---|---|
| R28 | e0/0 | **52.0.3.28** |2001:52:0:3::28<br>FE80::28| - | R28 e0/0 – e0/1 R26 | BGP, Provider link |
|  | e0/1 | **52.0.4.28** | 2001:52:0:4::28<br>FE80::28 | - | R28 e0/1 – e0/3 R25 | BGP, Provider link |
|  | e0/2 | 5.0.0.1 | 2001:5:0:0::1<br>FE80::1 | - | R28 e0/2 – e0/2 SW29 | Default (L2) |
| SW29 |  | 172.16.0.29 | 2001:172:16:0::29<br>FE80::29 | 1100 | - | Management |
|  |  |  |  | 300 | - | End Users |
|  |  |  |  | 310 | - | End Users |
| VPC30 | eth0 | 5.0.0.30 | 2001:5:0:0::30<br>FE80::30 | 300 |  | |
| VPC31 | eth0 | 5.0.0.31 | 2001:5:0:0::31<br>FE80::31 | 310 |  | |
...
Настройка прямого доступа в VLAN
```
...
SW2(config-if-range)#interface range ethernet 0/0 - 1
SW2(config-if-range)#no shutdown
SW2(config-if-range)#end
```
остальные выключим
```
SW3(config)#interface range ethernet 1/0, ether
SW3(config)#interface range ethernet 1/0, ethernet 1/2, ethe
SW3(config)#interface range ethernet 1/0, ethernet 1/2, ethernet 1/3
