# Планирование адресного пространства. Распределение IPv4/6
...
Современный офис. Офис меньше (т.е. не нужно настраивать много сетей), поэтому 
...
### Заметка про организацию L2 связности
